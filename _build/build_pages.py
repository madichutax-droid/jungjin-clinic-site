...
""" + P.tail(with_cta=False))
    ...
    pages["privacy"] = legal(
        ...
        [("1. 수집하는 개인정보 항목",
          ...
          ["전화로 진료를 예약하실 때 — 성명, 연락처",
           ...
           "치료 후기 회원으로 가입하실 때 — 이메일 주소, 표시 이름, 비밀번호"]),
         ...
         (("abroad", "5-1. 개인정보의 국외 이전"),
          ["치료 후기 회원으로 가입하시면 아래와 같이 개인정보가 국외로 이전됩니다. "
           "개인정보 보호법 제28조의8에 따라 가입 시 별도로 동의를 받습니다.",
           "동의를 거부하실 수 있습니다. 다만 회원가입과 치료 후기 이용은 하실 수 없으며, "
           "홈페이지의 나머지 기능과 진료 예약에는 영향이 없습니다."],
          ["이전받는 자 — Supabase, Inc.",
           "이전되는 국가 — 일본 (도쿄 리전)",
           "이전 항목 — 이메일 주소, 표시 이름, 암호화된 비밀번호",
    ...
    pages["terms"] = legal(
        ...
        [("제1조 (목적)",
         ...
         ("제3조의2 (회원가입과 탈퇴)", [],
          ["회원가입은 이메일 주소로 신청하며, 본원이 보낸 확인 메일의 링크를 "
           "누르시면 가입이 완료됩니다.",
