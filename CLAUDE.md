...
**카피와 운영 고정값은 노션이 기준입니다.** 히어로 대제목 · 푸터 시그니처 · 안전 문구 ·
CTA · 주소 · 전화 · 진료시간 · 비급여 금액을 바꿀 일이 있으면 노션 「정진한의원 브랜딩」의
표를 먼저 고치고 여기로 옮깁니다. 그 문서가 스스로 그렇게 정해 두었습니다.
2026-09-09 대조에서 양쪽은 전부 일치했습니다.
